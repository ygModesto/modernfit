...
public class FormUrlEncodedRepositoryImpl extends AbstractInterfaceImpl implements FormUrlEncodedRepository {
	...
	private FormUrlEncodedRepositoryImpl(Builder builder) {
	...
	@Override
	public User createUser(String name, String login) throws ModernfitException {
		final RequestInfo.Builder requestInfoBuilder = RequestInfo.baseUrl(this.baseUrl);
	...
	@Override
	public User createUser(Map<String, String> user) throws ModernfitException {
		final RequestInfo.Builder requestInfoBuilder = RequestInfo.baseUrl(this.baseUrl);
		requestInfoBuilder.addUrlPathAsConstant("/user/create");
	    requestInfoBuilder.addHttpMethod(HttpMethod.POST);
	    requestInfoBuilder.addHeaders(this.getHeaders());
	...
	@Override
	public User updateUser(Long id, String name, String login) throws ModernfitException {
		final RequestInfo.Builder requestInfoBuilder = RequestInfo.baseUrl(this.baseUrl);
	...
	public Collection<User> getUserAll() throws ModernfitException {
	  ...
	  public static class Builder {
		...
		public FormUrlEncodedRepositoryImpl build() {
			return new FormUrlEncodedRepositoryImpl(this);
		}
	}
