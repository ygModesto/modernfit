...
import com.ygmodesto.modernfit.processor.repository.RxJava3EchoResponseRepository;
...
public class RxJava3EchoResponseServerTest extends AbstractFunctionalTest {

  public static final Charset DEFAULT_CHARSET = StandardCharsets.UTF_8;

  private static RxJava3EchoResponseRepository rxEchoResponseRepository;
  private static ObjectMapper objectMapper;

  @BeforeClass
  public static void setUp() throws Exception {
    rxEchoResponseRepository = util(RxJava3EchoResponseRepository.class, "Impl");
