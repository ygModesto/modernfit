...
public interface FormUrlEncodedRepositoryRxJava2 {
  ...
  @FormUrlEncoded
  @POST("/user/create")
  Single<User> createUser(@Field String name, @Field String login);

  @FormUrlEncoded
  @POST("/user/create")
  Single<User> createUser(@FieldMap Map<String, String> user);

  @FormUrlEncoded
  @PUT("/user/update/{id}")
  Single<User> updateUser(@Path Long id, @Field String name, @Field String login);
