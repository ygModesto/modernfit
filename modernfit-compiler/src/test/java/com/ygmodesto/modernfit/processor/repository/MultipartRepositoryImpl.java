...
public class MultipartRepositoryImpl extends AbstractInterfaceImpl implements MultipartRepository {
	...
	private MultipartRepositoryImpl(Builder builder) {
	...
	@Override
	public Collection<User> createUsers(Collection<User> users, Collection<TypedContent> attacheds) throws ModernfitException {
		final RequestInfo.Builder requestInfoBuilder = RequestInfo.baseUrl(this.baseUrl);
	...
	@Override
	public Collection<User> createUsers(Map<String, User> users) throws ModernfitException {
		final RequestInfo.Builder requestInfoBuilder = RequestInfo.baseUrl(this.baseUrl);
		requestInfoBuilder.addUrlPathAsConstant("/users/createHeavy");
	    requestInfoBuilder.addHttpMethod(HttpMethod.POST);
	    requestInfoBuilder.addHeaders(this.getHeaders());
	...
	@Override
	public User updateUserAttacheds(Long id, Map<String, TypedContent> attacheds) throws ModernfitException {
		final RequestInfo.Builder requestInfoBuilder = RequestInfo.baseUrl(this.baseUrl);
		requestInfoBuilder.addUrlPathAsConstant("/user/");
		requestInfoBuilder.addUrlPathNotEncoded(id, this.urlConverter0);
	...
	@Override
	public User updateUser(Long id, User user, File file) throws ModernfitException {
		final RequestInfo.Builder requestInfoBuilder = RequestInfo.baseUrl(this.baseUrl);
	...
	public Collection<User> getUserAll() throws ModernfitException {
	  ...
	  public static class Builder {
		...
		public MultipartRepositoryImpl build() {
			return new MultipartRepositoryImpl(this);
		}
	}
