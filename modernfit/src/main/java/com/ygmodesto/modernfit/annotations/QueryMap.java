 ...
 * </code></pre>
 *
 * <p>Calling with {@code foo.friends(ImmutableMap.of("group", "coworker", "age", "42"))} yields
 ...
 * </code></pre>
 *
 * <p>Calling with {@code foo.list(ImmutableMap.of("group", "coworker+bowling"))} yields {@code
